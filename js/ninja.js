document.addEventListener("DOMContentLoaded", () => {
    const data = {
        ...
        // Definidas por fila (del 1 al 10)
        "rows": [
    ...
    // Inicializar puntos para todas las habilidades
    ...
    function renderSkills() {
        ...
        data.rows.forEach(rowData => {
            ...
            rowData.skills.forEach(skill => {
                ...
                // Clic izquierdo para sumar punto (+)
                ...
                // Clic derecho para restar punto (-)
